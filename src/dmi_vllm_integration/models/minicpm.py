...
# Adapted from vllm/model_executor/models/minicpm.py in official vLLM 0.27.1.
"""Dense MiniCPM decoder with DMI observation hooks."""
...
def _require_supported_minicpm_config(config) -> None:
    """Reject the MoE module tree that this dense instrumenter cannot attach."""
