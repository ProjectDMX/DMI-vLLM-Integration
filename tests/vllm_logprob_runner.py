...
class MonitoredLogitCaptureWorker(_LogitCaptureMixin, DMXGPUWorker):
...
def main():
    ...
    if args.ref:
        ...
        kwargs["worker_cls"] = (
            "tests.vllm_logprob_runner.MonitoredLogitCaptureWorker"
            if raw_logits_output
            else "dmi_vllm_integration.worker.DMXGPUWorker"
        )
        ...
        kwargs["worker_cls"] = (
            "tests.vllm_logprob_runner.StockLogitCaptureWorker"
        )
