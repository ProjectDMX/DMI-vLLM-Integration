"""CPU contracts for OLMo 3 monitoring support."""
...
def test_olmo3_pp_manifests_separate_local_and_model_wide_layers() -> None:
...
def test_olmo3_compare_handles_pipeline_stage_without_logits() -> None:
    subject = SimpleNamespace(
    ...
    assert (
        olmo3_compare.Olmo3CompareForCausalLM.compute_logits(
            subject,
            torch.zeros(1, 1),
        )
        is None
